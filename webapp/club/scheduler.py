    ...
    if end_club_products:
        for product in end_club_products:
            ...
            if product.achievement_rate == 100:
                product.club.achievement += 1
                print("달성률이 100% 되었습니다.")
                if product.club.achievement == 3:
                    product.club.level = 1
                    print("레벨1이 되었습니다.")
                elif product.club.achievement == 6:
                    product.club.level = 2
                    print("레벨2가 되었습니다.")
                elif product.club.achievement == 9:
                    product.club.level = 3
                    print("레벨3이 되었습니다.")
                elif product.club.achievement == 12:
                    product.club.level = 4
                    print("레벨4가 되었습니다.")
                elif product.club.achievement == 15:
